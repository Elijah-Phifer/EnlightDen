...
const PomodoroPage: React.FC = () => {
  ...
  return (
    <Container textAlign="center" style={{ marginTop: '50px' }}>
      ...
      <Header as="h2" style={{ fontSize: '16px' }}>Set the timer for however long you want to study, then click start!</Header>
      ...
      <div>
        ...
        <Button secondary onClick={handleReset} style={{ margin: '10px', padding: '10px', fontSize: '16px' }}>
          Reset
        </Button>
      </div>
